...
const { Product, Categories, Manufacturer, Review, State, User, User_address } = sequelize.models;
...
User.belongsToMany(User_address, {through: 'user_adress'})
User_address.belongsToMany(User, {through: 'user_adress'})

User_address.belongsToMany(State, {through: 'adress_state'})
State.belongsToMany(User_address, {through: 'adress_state'})
