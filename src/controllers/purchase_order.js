...
async function postPurchase_order({ idProduct, idUser,total, description, idMP, status, idAddress, branchOfficeId, productsJson}){
    let newOrder = await Purchase_order.create({ total, sucursal, status, idMP, description, productsJson})
